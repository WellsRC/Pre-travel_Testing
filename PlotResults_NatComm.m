...
% No test
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('Pre_Testing_NoTest_NatComm.mat','w','ts','td','PosttestIS','PosttestIA','PretestIS','PretestIA');
...
% RTPCR
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('Pre_Testing_RTPCR_NatComm.mat','w','ts','td','PosttestIS','PosttestIA','PretestIS','PretestIA');
RS=(w./ts).*PosttestIS+((ts-w)./ts).*PretestIS;
RA=(w./td).*PosttestIA+((td-w)./td).*PretestIA;
...
% BinaxNOW
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('Pre_Testing_BinaxNow_NatComm.mat','w','ts','td','PosttestIS','PosttestIA','PretestIS','PretestIA');
RS=(w./ts).*PosttestIS+((ts-w)./ts).*PretestIS;
RA=(w./td).*PosttestIA+((td-w)./td).*PretestIA;
...
% BDVeritor
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('Pre_Testing_BDVeritor_NatComm.mat','w','ts','td','PosttestIS','PosttestIA','PretestIS','PretestIA');
RS=(w./ts).*PosttestIS+((ts-w)./ts).*PretestIS;
RA=(w./td).*PosttestIA+((td-w)./td).*PretestIA;
...
% Sofia
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('Pre_Testing_Sofia_NatComm.mat','w','ts','td','PosttestIS','PosttestIA','PretestIS','PretestIA');
RS=(w./ts).*PosttestIS+((ts-w)./ts).*PretestIS;
RA=(w./td).*PosttestIA+((td-w)./td).*PretestIA;
...
% Lumarax
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('Pre_Testing_Lumarax_NatComm.mat','w','ts','td','PosttestIS','PosttestIA','PretestIS','PretestIA');
RS=(w./ts).*PosttestIS+((ts-w)./ts).*PretestIS;
RA=(w./td).*PosttestIA+((td-w)./td).*PretestIA;
...
subplot('Position',[0.078026315789474,0.136779071547693,0.4,0.834686557505484]);
...
set(gca,'LineWidth',2,'tickdir','out','XTick',[0:7],'XminorTick','on','YTick',[0:0.05:0.95],'Yminortick','on','Fontsize',22, 'xdir', 'reverse' );
ylim([0. 0.9])
xlim([0 7]);
xlabel('Days pre-departure test conducted','Fontsize',28);
ylabel('Post-quarantine transmission','Fontsize',28);
...
subplot('Position',[0.588157894736841,0.136779071547693,0.4,0.834686557505484]);
...
set(gca,'LineWidth',2,'tickdir','out','XTick',[0:7],'XminorTick','on','YTick',[0:0.02:0.32],'Yminortick','on','Fontsize',22, 'xdir', 'reverse' );
ylim([0 0.32])
xlim([0 7]);
xlabel('Days pre-departure test conducted','Fontsize',28);
ylabel({'Probability of','post-quarantine transmission'},'Fontsize',28);
